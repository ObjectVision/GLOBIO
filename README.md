...
<summary><b>Source data</b></summary>
  <p>
    ...
    <ol>
      <li><b>Claim1970.csv</b> (added missing regions, see data/Claim1970.csv):  claims per landuse class per IMAGE region for the complete sets of landuse classes and IMAGE regions</li>
      ...
      <li><b>Regions.csv</b> (see data/Regions.csv): csv file with fields: Region;Nr;Countries for example Ukraine region;14;Belarus (112), Moldova (498), Ukraine (804) </li>
